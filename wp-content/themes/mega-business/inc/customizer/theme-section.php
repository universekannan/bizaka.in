...
$default = mega_business_get_default_theme_options();

// Add Panel.
$wp_customize->add_panel( 'theme_option_panel',
	array(
	'title'      => __( 'Theme Options', 'mega-business' ),
	'priority'   => 100,
...
'title'       => __('Layout Option', 'mega-business'),
...
$wp_customize->add_setting('theme_options[layout_options_blog]', 
	...
	'type'              => 'theme_mod',
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'mega_business_sanitize_select'
	)
);

$wp_customize->add_control(new mega_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_blog]', 
	array(		
	'label' 	=> __('Blog Layout', 'mega-business'),
...
$wp_customize->add_control(new mega_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_archive]', 
	array(		
	'label' 	=> __('Archive Layout', 'mega-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new mega_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_page]', 
	array(		
	'label' 	=> __('Page Layout', 'mega-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_control(new mega_business_Image_Radio_Control($wp_customize, 'theme_options[layout_options_single]', 
	array(		
	'label' 	=> __('Single Post Layout', 'mega-business'),
	'section' 	=> 'section_general',
...
$wp_customize->add_section('section_excerpt_length', 
	array(    
	'title'       => __('Excerpt Length', 'mega-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[excerpt_length]', array(
	...
	'sanitize_callback' => 'mega_business_sanitize_number_range',
) );
$wp_customize->add_control( 'theme_options[excerpt_length]', array(
	'label'       => __( 'Excerpt Length', 'mega-business' ),
	'description' => __( 'in words', 'mega-business' ),
...
$wp_customize->add_section('section_blog_title', 
	array(    
	'title'       => __('Blog Title', 'mega-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[your_latest_posts_title]',
	array(
	'label'    => __( 'Blog Title', 'mega-business' ),
...
$wp_customize->add_section('section_read_more', 
	array(    
	'title'       => __('Read More Text', 'mega-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_setting( 'theme_options[readmore_text]',
	...
	'capability'        => 'edit_theme_options',
	'sanitize_callback' => 'mega_business_sanitize_textarea_content',
	'transport'         => 'refresh',
	)
);
$wp_customize->add_control( 'theme_options[readmore_text]',
	array(
	'label'    => __( 'Read More Text', 'mega-business' ),
...
$wp_customize->add_section('section_footer', 
	array(    
	'title'       => __('Footer Setting', 'mega-business'),
	'panel'       => 'theme_option_panel'    
	)
);
...
$wp_customize->add_control( 'theme_options[copyright_text]',
	array(
	'label'    => __( 'Copyright Text', 'mega-business' ),
...
$wp_customize->add_setting( 'theme_options[disable_frontpage_header_image]', array(
	...
	'sanitize_callback'   => 'mega_business_sanitize_checkbox',
) );

$wp_customize->add_control( 'theme_options[disable_frontpage_header_image]', array(
	'label'       	=> esc_html__( 'Disable in Front Page', 'mega-business' ),
