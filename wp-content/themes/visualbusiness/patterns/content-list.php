<?php
 /**
  * Title: Content List
  * Slug: visualbusiness/content-list
  * Categories: visualbusiness
  */
?>

<!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}},"border":{"radius":"4px"}},"backgroundColor":"background","className":"content-loop","layout":{"type":"constrained"}} -->
<div class="wp-block-group content-loop has-background-background-color has-background" style="border-radius:4px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:query {"queryId":11,"query":{"perPage":"10","pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"list"}} -->
<div class="wp-block-query"><!-- wp:post-template -->
<!-- wp:post-featured-image {"isLink":true,"width":"210px","height":"210px","style":{"spacing":{"margin":{"right":"1.6rem","top":"0px","bottom":"0px","left":"0px"}},"border":{"radius":"4px"}}} /-->
