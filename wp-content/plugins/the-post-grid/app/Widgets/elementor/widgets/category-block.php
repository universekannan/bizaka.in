...
class TPGCategoryBlock extends Custom_Widget_Base {
	...
	public function __construct( $data = [], $args = null ) {
		...
		$this->tpg_name = esc_html__( 'TPG - Category Block', 'the-post-grid-pro' );
...
//			'render_type'    => 'template'
		...
		$this->add_control( 'cat_tag', [
			'label'   => esc_html__( 'Choose Category Tag', 'the-post-grid-pro' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'h3',
			'options' => [
		...
		$this->add_control( 'cat_spacing', [
			'label'              => esc_html__( 'Category Spacing', 'the-post-grid-pro' ),
		...
		$this->add_control( 'cat_padding', [
			'label'      => esc_html__( 'Category Padding', 'the-post-grid-pro' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px' ],
			'selectors'  => [
		...
		$this->add_control( 'category_color', [
			'label'     => esc_html__( 'Category Color', 'the-post-grid-pro' ),
		...
		$this->add_control( 'category_color_hover', [
			'label'     => esc_html__( 'Category Color - Hover', 'the-post-grid-pro' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_group_control( \Elementor\Group_Control_Border::get_type(), [
			'name'     => 'img_border',
			'label'    => esc_html__( 'Image Border', 'the-post-grid-pro' ),
		...
		$this->add_group_control( \Elementor\Group_Control_Border::get_type(), [
			...
			'label'    => esc_html__( 'Image Border - Hover', 'the-post-grid-pro' ),
		...
		$this->add_control( 'count_color', [
			'label'     => esc_html__( 'Count Color', 'the-post-grid-pro' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_control( 'count_bg', [
			'label'     => esc_html__( 'Count Background', 'the-post-grid-pro' ),
			'type'      => \Elementor\Controls_Manager::COLOR,
		...
		$this->add_group_control( \Elementor\Group_Control_Border::get_type(), [
			'name'     => 'count_border',
			'label'    => esc_html__( 'Count Border', 'the-post-grid-pro' ),
			'selector' => '{{WRAPPER}} .count',
		] );
		...
		$this->add_group_control( \Elementor\Group_Control_Border::get_type(), [
			...
			'label'    => esc_html__( 'Border - Hover', 'the-post-grid-pro' ),
