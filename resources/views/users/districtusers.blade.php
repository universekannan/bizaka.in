   ...
   <div class="container-fluid">
      <div class="row mb-2">
         <div class="col-sm-6">
            ...
            <h1>District Users</h1>
            @elseif(Auth::user()->user_type_id == 2) 
            <h1>District Presidents</h1>
            @elseif(Auth::user()->user_type_id == 3) 
            <h1>District Secretarys</h1>
			@endif
         </div>
         <div class="col-sm-6">
		    @if((Auth::user()->user_type_id == 2) || (Auth::user()->user_type_id == 3))
          		<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><button type="button" class="btn btn-block btn-primary btn-sm" data-toggle="modal" data-target="#districtusers"><i class="fa fa-plus"> Add </i></button></li>
			 @else
			 @endif
         </div>
      </div>
			    ...
			    @if (session()->has('success'))
				 ...
				 @if (session()->has('error'))
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                     ...
                     <tbody>
                        @foreach($districtusers as $key=>$districtuserslist)
                        <tr>
                           <td>{{ $key + 1 }}</td>
                           <td>{{ $districtuserslist->district_name }}</td>
                           <td>{{ $districtuserslist->full_name }}</td>
                           <td>{{ $districtuserslist->email }}</td>
                           <td>{{ $districtuserslist->phone }}</td>
                           <td>{{ $districtuserslist->status }}</td>
                           <td>
                              <div class="btn-group">
                                 ...
                                 <div class="dropdown-menu" role="menu">
                                  <a class="dropdown-item" href="{{ url('/edituser', $districtuserslist->userID) }}">Edit User</a>

								 <a onclick="userdatas('{{ $districtuserslist->id }}','{{ $districtuserslist->full_name }}','{{ $districtuserslist->profile_photo }}','{{ $districtuserslist->username }}','{{ $districtuserslist->district_name }}','{{ $districtuserslist->email }}','{{ $districtuserslist->pas }}','{{ $districtuserslist->phone }}','{{ $districtuserslist->status }}')" type="button" class="dropdown-item">View User</a>
...
<div class="modal fade" id="districtusers">
   <div class="modal-dialog modal-xl">
      <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Add District Users Details</h4>
            ...
            <div class="row">
               <div class="col-md-6">
			      <div class="form-group">
                     ...
                     <select class="form-control select2" name="dist_id"  style="width: 100%;">
